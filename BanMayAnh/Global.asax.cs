    ...
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            List<MayAnh> sp = new List<MayAnh>
            {
                ...
                new MayAnh { Id = 5, Tensp = "MÁY ẢNH SIÊU ZOOM FUJIFILM FINEPIX S100FS CŨ", Gia = "2,000,000₫", Anh = "anh/May_anh_sieu_zoom_fujifilm_finepix_s100fs.png", Link="ChiTietSanPham.aspx" },
                ...
                new MayAnh { Id = 10, Tensp = "Sony Alpha A3000 & kit cũ đẹp", Gia = "5,000,000₫", Anh = "anh/May_anh_Sony_Alpha_A3000.jpg", Link="ChiTietSanPham.aspx", Loai = "sony" },
